...
export const GlobalChat = () => {
  ...
  const [inviteLink, setInviteLink] = useState("https://discord.gg/qTT2bVzVv");
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-52">
                <DropdownMenuItem onSelect={() => window.open(inviteLink || "https://discord.gg/qTT2bVzVv", "_blank", "noopener,noreferrer")}>
