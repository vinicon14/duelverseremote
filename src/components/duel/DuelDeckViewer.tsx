  ...
  const broadcastState = useCallback(() => {
    ...
    broadcastChannel.send({
      ...
      payload: {
        ...
        field: getFieldCards(),
        monsterZones: {
          monster1: fieldState.monster1 ? { id: fieldState.monster1.id, name: fieldState.monster1.isFaceDown ? 'Face-down' : fieldState.monster1.name, image: fieldState.monster1.isFaceDown ? CARD_BACK_URL : fieldState.monster1.card_images?.[0]?.image_url_small, isFaceDown: fieldState.monster1.isFaceDown, position: fieldState.monster1.position, materials: fieldState.monster1.attachedCards?.length || 0, atk: fieldState.monster1.isFaceDown ? undefined : fieldState.monster1.atk, def: fieldState.monster1.isFaceDown ? undefined : fieldState.monster1.def } : null,
          monster2: fieldState.monster2 ? { id: fieldState.monster2.id, name: fieldState.monster2.isFaceDown ? 'Face-down' : fieldState.monster2.name, image: fieldState.monster2.isFaceDown ? CARD_BACK_URL : fieldState.monster2.card_images?.[0]?.image_url_small, isFaceDown: fieldState.monster2.isFaceDown, position: fieldState.monster2.position, materials: fieldState.monster2.attachedCards?.length || 0, atk: fieldState.monster2.isFaceDown ? undefined : fieldState.monster2.atk, def: fieldState.monster2.isFaceDown ? undefined : fieldState.monster2.def } : null,
          monster3: fieldState.monster3 ? { id: fieldState.monster3.id, name: fieldState.monster3.isFaceDown ? 'Face-down' : fieldState.monster3.name, image: fieldState.monster3.isFaceDown ? CARD_BACK_URL : fieldState.monster3.card_images?.[0]?.image_url_small, isFaceDown: fieldState.monster3.isFaceDown, position: fieldState.monster3.position, materials: fieldState.monster3.attachedCards?.length || 0, atk: fieldState.monster3.isFaceDown ? undefined : fieldState.monster3.atk, def: fieldState.monster3.isFaceDown ? undefined : fieldState.monster3.def } : null,
        ...
        extraMonsterZones: {
          extraMonster1: fieldState.extraMonster1 ? { id: fieldState.extraMonster1.id, name: fieldState.extraMonster1.isFaceDown ? 'Face-down' : fieldState.extraMonster1.name, image: fieldState.extraMonster1.isFaceDown ? CARD_BACK_URL : fieldState.extraMonster1.card_images?.[0]?.image_url_small, materials: fieldState.extraMonster1.attachedCards?.length || 0, atk: fieldState.extraMonster1.isFaceDown ? undefined : fieldState.extraMonster1.atk, def: fieldState.extraMonster1.isFaceDown ? undefined : fieldState.extraMonster1.def } : null,
          extraMonster2: fieldState.extraMonster2 ? { id: fieldState.extraMonster2.id, name: fieldState.extraMonster2.isFaceDown ? 'Face-down' : fieldState.extraMonster2.name, image: fieldState.extraMonster2.isFaceDown ? CARD_BACK_URL : fieldState.extraMonster2.card_images?.[0]?.image_url_small, materials: fieldState.extraMonster2.attachedCards?.length || 0, atk: fieldState.extraMonster2.isFaceDown ? undefined : fieldState.extraMonster2.atk, def: fieldState.extraMonster2.isFaceDown ? undefined : fieldState.extraMonster2.def } : null,
        },
