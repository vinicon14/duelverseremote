...
export const ShareVideoButton = ({ 
  ...
  const shareMessage = `🎮 ${videoTitle}\n\n${videoDescription || 'Confira essa partida incrível no DuelVerse!'}\n\n`;
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Compartilhe esta partida com seus amigos
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button
              ...
              variant="outline"
              className="w-full bg-sky-50 hover:bg-sky-100 dark:bg-sky-950 dark:hover:bg-sky-900"
            >
              <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
