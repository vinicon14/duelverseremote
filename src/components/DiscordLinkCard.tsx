/**
 * Componente de vinculação Discord
 * Permite ao usuário conectar/desconectar a conta Discord à conta DuelVerse
 */
...
export const DiscordLinkCard = () => {
  ...
  // Tratar callback de sucesso/erro do OAuth
  useEffect(() => {
  ...
  const handleLink = async () => {
    ...
    try {
      ...
      const resp = await fetch(
        `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/discord-oauth-start`,
        {
          method: "POST",
          headers: {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {loading ? (
          ...
          <>
            <p className="text-sm text-muted-foreground">
              Vincule sua conta Discord para que suas mensagens apareçam com seu nome e avatar
              Discord nos servidores conectados, e mensagens enviadas no Discord apareçam no
              chat global do DuelVerse com sua identidade.
            </p>
