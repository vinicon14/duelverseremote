...
import { Trophy, Plus, Loader2, RefreshCw } from "lucide-react";
      ...
      <main className="container mx-auto px-4 pt-20 sm:pt-24 pb-12">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gradient-mystic">{t('weeklyTournaments.title')}</h1>
              <p className="text-muted-foreground">
                {t('weeklyTournaments.subtitle')}
              </p>
            </div>
          </div>
          <Button
        ...
        {!loading && tournaments.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-medium mb-2">{t('weeklyTournaments.empty')}</h3>
            <p className="text-muted-foreground mb-6">
              {t('weeklyTournaments.emptyDesc')}
            </p>
            <Button
              onClick={() => navigate("/create-weekly-tournament")}
              className="btn-mystic text-white"
