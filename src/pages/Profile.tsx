              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-4 justify-center md:justify-start">
                  <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-primary/10">
                    ...
                    <span className="text-sm sm:text-base font-semibold">{t('profile.level', { level: profile?.level || 1 })}</span>
                  </div>
                  <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-primary/10">
                    <Star className="w-4 h-4 sm:w-5 sm:h-5 text-primary" />
                    <span className="text-sm sm:text-base font-semibold">{t('profile.points', { points: profile?.points || 0 })}</span>
                  </div>
                </div>
              </div>
