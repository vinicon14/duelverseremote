        ...
        async (payload) => {
          ...
          if (payload.new) {
            ...
            setDuel((prev: any) => prev ? {
              ...prev,
              ...payload.new,
              // payload.new é um row bruto: nunca contém os perfis unidos.
              // Preservar os objetos creator/opponent que vieram do fetch inicial
