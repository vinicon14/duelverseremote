...
export default function InstallApp() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative z-50 bg-background/80 backdrop-blur-sm px-4 py-8">
      <div className="router-view-animate mx-auto my-auto w-full max-w-md space-y-6 text-center">
